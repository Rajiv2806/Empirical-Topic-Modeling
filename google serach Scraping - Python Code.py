...
#%%
search_terms = ['arjun mbt','hal tejas','INS Arihant']

for sterm in search_terms:
    urllist = []
    for url in search(sterm, tld='co.in', lang='en', stop=10):
        url = re.sub("#.*$","",url)
...
# drop duplicate URL        
    ...
    out_text.to_csv("C:\\Users\\30773\\Desktop"+sterm+" google search.csv")
    
    out_xls.to_csv("C:\\Users\\30773\\Desktop"+sterm+" google search list.csv")
